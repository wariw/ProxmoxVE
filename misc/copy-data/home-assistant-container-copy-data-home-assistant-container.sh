...
# Use to copy all data from one Home Assistant LXC to another
# run from the Proxmox Shell
# bash -c "$(wget -qLO - https://raw.githubusercontent.com/wariw/ProxmoxVE/refs/heads/alpine-caddy/misc/copy-data/home-assistant-container-copy-data-home-assistant-container.sh)"
